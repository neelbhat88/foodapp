...
class FoodItemsControllerTest < ActionController::TestCase
  ...
  test "should create food_item" do
    assert_difference('FoodItem.count') do
      post :create, food_item: { category: @food_item.category, datebought: @food_item.datebought, epxpirationdays: @food_item.epxpirationdays, name: @food_item.name, usebydate: @food_item.usebydate }
    end
  ...
  test "should update food_item" do
    put :update, id: @food_item, food_item: { category: @food_item.category, datebought: @food_item.datebought, epxpirationdays: @food_item.epxpirationdays, name: @food_item.name, usebydate: @food_item.usebydate }
    assert_redirected_to food_item_path(assigns(:food_item))
  end
